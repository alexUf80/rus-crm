{$meta_title="order_sold" scope=parent}
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">
                    Проведение цессии по уступленным договорам
                </h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Главная</a></li>
                    <li class="breadcrumb-item active">Проданные договора</li>
                </ol>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="alert alert-info">
                                            ...
                                            <br />
                                            В первой строке должны быть наименования ячеек (number(номер контракта), od(сумма основного долга), percents(сумма процентов), date (дата уступки договора)).
                                            <br />
                                        </div>
                                    </div>
                                </div>
