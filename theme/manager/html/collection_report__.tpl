                                ...
                                <table class="jsgrid-table table table-striped table-hover">
                                    ...
                                    {foreach $collectors as $collector}
                                        ...
                                        <tr class="jsgrid-row {if $manager->role!='collector'}js-open-show{/if} js-dopinfo-{$collector->id}" >
                                            ...
                                            <td style="width: 70px;" class="jsgrid-cell">
                                                {if $item->closed}<span class="label label-info">Закрыт</span>
                                                {elseif $item->prolongation}<span class="label label-success">Пролонгация</span>
                                                {else}<span class="label label-danger">Оплата</span>{/if}
                                            </td>
                                            <td style="width: 70px;" class="jsgrid-cell">
                                                <span class="">
