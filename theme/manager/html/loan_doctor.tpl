{$meta_title='Кредитный доктор' scope=parent}
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0"><i class="mdi mdi-chart-bubble"></i> Кредитный доктор</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Главная</a></li>
                    <li class="breadcrumb-item active">Кредитный доктор</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Кредитный доктор</h4>
                                ...
                                <table class="jsgrid-table table table-striped table-hover ">
                                    ...
                                    {foreach $clients as $client}
                                        <tr class="jsgrid-row">
                                            ...
                                            <td style="width: 100px;" class="jsgrid-cell">
                                                <a href="{$client->link}" target="_blank" class="btn btn-info"><i
